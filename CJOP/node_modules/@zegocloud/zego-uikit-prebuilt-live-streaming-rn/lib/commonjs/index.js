...
function ZegoUIKitPrebuiltLiveStreaming(props, ref) {
  ...
  const registerPluginCallback = () => {
    if (_zegoUikitRn.default.getPlugin(_zegoUikitRn.ZegoUIKitPluginType.signaling)) {
      ...
      _zegoUikitRn.default.getSignalingPlugin().onInRoomTextMessageReceived(callbackID, message => {
...
var _default = exports.default = /*#__PURE__*/(0, _react.forwardRef)(ZegoUIKitPrebuiltLiveStreaming);
