    ...
    const fetchPhoneNumber = async () =>{
        ...
        try {
             ...
             if(data.length > 0) 
             {
                 ...
                 {
                     console.log("Account suspended. Please contact the relevant help center for more info.");
                     Alert.alert(
                         'Login error',
                         'Account suspended. Please contact the help center for more info.',
