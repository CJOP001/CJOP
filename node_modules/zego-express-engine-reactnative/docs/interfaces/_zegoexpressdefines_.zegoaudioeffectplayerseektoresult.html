...
<head>
	...
	<title>ZegoAudioEffectPlayerSeekToResult | zego-express-engine-reactnative</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_zegoexpressdefines_.zegoaudioeffectplayerseektoresult.html">ZegoAudioEffectPlayerSeekToResult</a>
				</li>
			</ul>
			<h1>Interface ZegoAudioEffectPlayerSeekToResult</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">ZegoAudioEffectPlayerSeekToResult</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="_zegoexpressdefines_.zegoaudioeffectplayerseektoresult.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in src/ZegoExpressDefines.ts:2250</li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-parent-kind-module tsd-is-external">
						<a href="_zegoexpressdefines_.zegoaudioeffectplayerseektoresult.html" class="tsd-kind-icon">Zego<wbr>Audio<wbr>Effect<wbr>Player<wbr>Seek<wbr>ToResult</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="_zegoexpressdefines_.zegoaudioeffectplayerseektoresult.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a>
							</li>
						</ul>
					</li>
				</ul>
