...
<head>
	...
	<title>ZegoNetworkTimeInfo | zego-express-engine-reactnative</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_zegoexpressdefines_.zegonetworktimeinfo.html">ZegoNetworkTimeInfo</a>
				</li>
			</ul>
			<h1>Interface ZegoNetworkTimeInfo</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">ZegoNetworkTimeInfo</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="_zegoexpressdefines_.zegonetworktimeinfo.html#maxdeviation" class="tsd-kind-icon">max<wbr>Deviation</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="_zegoexpressdefines_.zegonetworktimeinfo.html#timestamp" class="tsd-kind-icon">timestamp</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a name="maxdeviation" class="tsd-anchor"></a>
					<h3>max<wbr>Deviation</h3>
					<div class="tsd-signature tsd-kind-icon">max<wbr>Deviation<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in src/ZegoExpressDefines.ts:1626</li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in src/ZegoExpressDefines.ts:1623</li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-parent-kind-module tsd-is-external">
						<a href="_zegoexpressdefines_.zegonetworktimeinfo.html" class="tsd-kind-icon">Zego<wbr>Network<wbr>Time<wbr>Info</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="_zegoexpressdefines_.zegonetworktimeinfo.html#maxdeviation" class="tsd-kind-icon">max<wbr>Deviation</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="_zegoexpressdefines_.zegonetworktimeinfo.html#timestamp" class="tsd-kind-icon">timestamp</a>
							</li>
						</ul>
					</li>
				</ul>
