...
<head>
	...
	<title>ZegoMediaPlayerLoadResourceResult | zego-express-engine-reactnative</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_zegoexpressdefines_.zegomediaplayerloadresourceresult.html">ZegoMediaPlayerLoadResourceResult</a>
				</li>
			</ul>
			<h1>Interface ZegoMediaPlayerLoadResourceResult</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Callback for media player loads resources.</p>
					</div>
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">ZegoMediaPlayerLoadResourceResult</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="_zegoexpressdefines_.zegomediaplayerloadresourceresult.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in src/ZegoExpressDefines.ts:2220</li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-parent-kind-module tsd-is-external">
						<a href="_zegoexpressdefines_.zegomediaplayerloadresourceresult.html" class="tsd-kind-icon">Zego<wbr>Media<wbr>Player<wbr>Load<wbr>Resource<wbr>Result</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="_zegoexpressdefines_.zegomediaplayerloadresourceresult.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a>
							</li>
						</ul>
					</li>
				</ul>
