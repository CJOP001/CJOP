...
export default class ZegoPluginRoomPropertiesCore {
  ...
  updateRoomProperty(attributes, config) {
    ...
    return new Promise((resolve, reject) => {
      ZegoUIKitCorePlugin.getZIMPlugin().default.getInstance().setRoomAttributes(attributes, roomID, config).then(_ref3 => {
        let {
          roomID: resRoomID,
          errorKeys
        } = _ref3;
  ...
  deleteRoomProperties(keys, config) {
    ...
    const roomID = ZegoPluginUserInRoomAttributesCore.getInstance().getRoomBaseInfo().roomID;
    return new Promise((resolve, reject) => {
      ZegoUIKitCorePlugin.getZIMPlugin().default.getInstance().deleteRoomAttributes(keys, roomID, config).then(_ref4 => {
        let {
          roomID: resRoomID,
          errorKeys
        } = _ref4;
  ...
  endRoomPropertiesBatchOperation() {
    ...
    const roomID = ZegoPluginUserInRoomAttributesCore.getInstance().getRoomBaseInfo().roomID;
    return new Promise((resolve, reject) => {
      ZegoUIKitCorePlugin.getZIMPlugin().default.getInstance().endRoomAttributesBatchOperation(roomID).then(_ref5 => {
        let {
          roomID: resRoomID
        } = _ref5;
  ...
  queryRoomProperties() {
    ...
    const roomID = ZegoPluginUserInRoomAttributesCore.getInstance().getRoomBaseInfo().roomID;
    return new Promise((resolve, reject) => {
      ZegoUIKitCorePlugin.getZIMPlugin().default.getInstance().queryRoomAllAttributes(roomID).then(_ref6 => {
        let {
          roomID: resRoomID,
          roomAttributes
        } = _ref6;
