...
function PictureInPictureLayout(props) {
  ...
  }, globalAudioVideoUserList.slice(1, 4).map((user, index) => /*#__PURE__*/_react.default.createElement(_reactNative.TouchableWithoutFeedback, _extends({
    key: user.userID
