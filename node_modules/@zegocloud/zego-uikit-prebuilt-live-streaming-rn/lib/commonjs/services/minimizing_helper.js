...
var _prebuilt_helper = _interopRequireDefault(require("./prebuilt_helper"));
var _class;
...
class MinimizingHelper {
  ...
  updateActiveUserIDByTimer() {
    const activeUserID = _prebuilt_helper.default.getInstance().getRealTimeData().hostID;
    this._activeUserID = activeUserID || _zegoUikitRn.default.getLocalUserInfo().userID || '';
